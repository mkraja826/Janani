...
- Approved Janani app icon from the final production candidate build
- Feature graphic
...
If Care+ purchases are disabled by the production feature gate, subscription products and AI claims must not be presented as available in the store listing. If they are enabled later, Play subscription terms, pricing, purchase restoration, server verification, and applicable AI/privacy disclosures must be complete before submission.
