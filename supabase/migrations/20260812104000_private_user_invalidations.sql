...
-- A user may receive broadcasts only from the channel named for their own
-- authenticated user id. The payload contains only an allow-listed entity
-- name; medical values are never broadcast.
