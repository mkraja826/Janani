...
begin
  ...
  v_full := public.get_current_own_mother_context();

  -- Keep clinician-wide instructions available in all contexts because they
  -- can constrain otherwise general guidance. Detailed history is selected
  ...
  -- Health profile is useful for nutrition/weight questions and also carries
  -- allergies, which should constrain food suggestions. It is not sent for an
  -- unrelated pregnancy-stage question.
