...
module.exports = function withJananiHealthConnect(config) {
  ...
  config = withAppBuildGradle(config, (mod) => {
    ...
    contents = contents.replace(/minSdkVersion\s+rootProject\.ext\.minSdkVersion/g, 'minSdkVersion 26');
