...
const WIDGETS = [
  ['JananiCareWidget', 'PregaLove Today', 'janani_care_widget_info'],
  ['JananiMedicineWidget', 'PregaLove Medicine', 'janani_medicine_widget_info'],
