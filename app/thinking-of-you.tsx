...
export default function ThinkingOfYouScreen() {
  ...
  return <SafeAreaView style={styles.page}>
    <ScrollView contentContainerStyle={styles.content}>
      ...
      {offlineCopy && <View style={styles.offline}><Ionicons name="cloud-offline-outline" size={18} color={colors.roseDark} /><Text style={styles.offlineText}>Showing the last saved messages. New updates will appear when you reconnect.</Text></View>}
