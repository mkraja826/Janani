  ...
  return (
    <SafeAreaView style={styles.page}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <LegalSection title="4. Service providers" body="Janani uses Supabase for authentication, database storage, realtime synchronization and server functions. Expo services may process device tokens and notification content to deliver push notifications. GitHub hosts Janani's public legal and support site. Those providers may process technical logs under their own terms and privacy practices. Janani does not sell personal information or use its legal site for advertising analytics." />
        ...
        <LegalSection title="8. Your choices" body="You can change notification permission in device settings, choose whether individual journal entries are shared, export your data, leave or disconnect a family relationship where the app provides that option, and delete your account." />
        ...
        <LegalSection title="12. Contact and privacy requests" body="Janani's public support instructions must not be used to post sensitive information. Never publish passwords, family invite codes, pregnancy or health information, journal content, medication details, or other private information in a public issue." />
