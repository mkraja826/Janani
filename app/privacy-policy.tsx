  ...
  return (
    <SafeAreaView style={styles.page}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <LegalSection title="4. Service providers and Care+ AI" body="PregaLove uses Supabase for authentication, database storage, realtime synchronization and server functions. Expo services may process device tokens and notification content to deliver push notifications. GitHub currently hosts the public legal and support site. When an eligible user asks Care+, PregaLove's protected server function may send the question and only the relevant context needed for that request to the configured AI model provider. The AI provider may process that request under its own service terms and privacy safeguards. PregaLove does not sell personal information or use its legal site for advertising analytics." />
        <LegalSection title="5. Device permissions and local storage" body="Notification permission is used for care and partner alerts. Android reboot and widget functionality may be used to restore reminders and display selected care information. PregaLove may keep an on-device cache, widget state and pending synchronization queue. Device settings can limit permissions, and clearing app data or uninstalling removes app-controlled local storage from that device." />
        <LegalSection title="6. Security" body="PregaLove uses authenticated access controls, database Row Level Security, protected server functions and restricted access to device tokens. Data is sent over encrypted network connections supported by the app and its providers. No application or storage system can guarantee absolute security." />
        ...
        <LegalSection title="9. Children" body="PregaLove is intended for adults managing a pregnancy journey and is not directed to children." />
        <LegalSection title="10. Medical and emergency information" body="PregaLove does not monitor symptoms or contact emergency services. Severe pain, heavy bleeding, breathing difficulty, fainting, seizures, reduced consciousness, or any urgent concern requires immediate contact with local emergency services or a qualified maternity-care professional." />
        <LegalSection title="11. Changes to this policy" body="This policy may change as PregaLove changes. The effective date will be updated when a revised policy is published." />
        <LegalSection title="12. Contact and privacy requests" body="Public support instructions must not be used to post sensitive information. Never publish passwords, family invite codes, pregnancy or health information, journal content, medication details, Care+ conversations, or other private information in a public issue." />
        ...
        <Text style={styles.footer}>The published web copy remains the public legal reference for store listings and users who are not signed in.</Text>
      </ScrollView>
    </SafeAreaView>
  );
}
