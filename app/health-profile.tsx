...
export default function HealthProfileScreen() {
  ...
  return <SafeAreaView style={styles.page}><ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
    ...
    <View style={[styles.notice, rtl.row]}><Ionicons name="lock-closed-outline" size={22} color={colors.roseDark} /><Text style={[styles.noticeText, rtl.startText]}>These details are mother-only by default. Janani records what you report and does not diagnose a condition or change treatment.</Text></View>
