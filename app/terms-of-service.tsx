  ...
  return (
    <SafeAreaView style={styles.page}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.notice}><Ionicons name="medical-outline" size={23} color={colors.rose} /><Text style={styles.noticeText}><Text style={styles.noticeStrong}>PregaLove is not a medical device. </Text>It does not diagnose, prescribe, monitor a medical condition, or replace a doctor, hospital, emergency service, or individualized medical advice.</Text></View>

        <LegalSection title="1. Acceptance" body="By using PregaLove, you agree to these Terms of Use and the Privacy Policy. Do not use the service if you do not agree." />
        <LegalSection title="2. Intended use" body="PregaLove supports pregnancy journaling, care reminders, pregnancy-date calculations, voluntary family connection and supportive Care+ features. Its information is general and educational." />
        ...
        <LegalSection title="4. Emergencies" body="Do not rely on PregaLove during an emergency. For severe pain, heavy bleeding, breathing difficulty, fainting, seizures, reduced consciousness, or any urgent concern, contact local emergency services or a qualified maternity-care professional immediately." />
        ...
        <LegalSection title="10. No warranty" body="To the maximum extent permitted by applicable law, PregaLove is provided without warranties of uninterrupted operation, medical accuracy, data preservation, AI accuracy, or fitness for emergency or clinical use. Nothing in these terms excludes rights that cannot lawfully be excluded." />
