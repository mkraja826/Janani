...
const styles = StyleSheet.create({
  ...
  sectionHeader:{gap:3},sectionTitle:{fontSize:18,fontWeight:'900',color:colors.ink},sectionCaption:{fontSize:12.5,lineHeight:18,color:colors.muted},quickRow:{flexDirection:'row',flexWrap:'wrap',gap:spacing.sm},quickAction:{width:'48.5%',minHeight:70,padding:spacing.sm,borderRadius:19,borderWidth:1,borderColor:colors.border,backgroundColor:colors.surface,flexDirection:'row',gap:spacing.sm,alignItems:'center'},quickIcon:{width:38,height:38,borderRadius:14,alignItems:'center',justifyContent:'center',backgroundColor:colors.roseSoft},quickText:{flex:1,fontSize:12.5,fontWeight:'900',color:colors.ink},
  inputCard:{gap:spacing.md,padding:spacing.lg,borderRadius:24,backgroundColor:colors.surface,borderWidth:1,borderColor:colors.border,shadowColor:colors.shadow,shadowOffset:{width:0,height:6},shadowOpacity:.06,shadowRadius:16,elevation:3},inputLabelRow:{flexDirection:'row',alignItems:'center',gap:spacing.sm},askIcon:{width:36,height:36,borderRadius:13,alignItems:'center',justifyContent:'center',backgroundColor:colors.roseSoft},label:{flex:1,fontSize:15,fontWeight:'900',color:colors.ink},input:{minHeight:132,padding:spacing.md,borderRadius:18,borderWidth:1,borderColor:colors.border,backgroundColor:colors.surfaceWarm,color:colors.ink,fontSize:15,lineHeight:22,textAlignVertical:'top'},askButton:{minHeight:52,borderRadius:radius.pill,backgroundColor:colors.rose,flexDirection:'row',alignItems:'center',justifyContent:'center',gap:spacing.sm},askButtonDisabled:{opacity:.45},askButtonText:{fontSize:15,fontWeight:'900',color:colors.surface},
