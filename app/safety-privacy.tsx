      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.linkCard}>
          ...
          <Pressable onPress={() => router.push('/terms-of-service')} style={styles.linkButton}>
            ...
            <Text style={styles.linkText}>Terms of Service & Medical Disclaimer</Text>
            <Ionicons name="chevron-forward" size={17} color={colors.muted} />
          </Pressable>
          <Pressable onPress={() => router.push('/billing')} style={styles.linkButton}>
            <Ionicons name="card-outline" size={20} color={colors.rose} />
            <Text style={styles.linkText}>Care+ plan & billing</Text>
            <Ionicons name="chevron-forward" size={17} color={colors.muted} />
          </Pressable>
        </View>
        ...
        <Text style={styles.footer}>Legal pages last updated September 2, 2026.</Text>
      </ScrollView>
    </SafeAreaView>
  );
}
