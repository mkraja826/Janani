...
import { INDIA_REGION_OPTIONS, normalizeRegion, readRegionalDietContext, writeRegionalDietContext, type DietPreference } from '@/features/diet/regionalDiet';
...
export default function DietRegionScreen() {
  ...
  async function save() {
    ...
    await writeRegionalDietContext(context);
    router.back();
  }
