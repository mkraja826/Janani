...
function BackgroundFeature({icon,text}:{icon:keyof typeof Ionicons.glyphMap;text:string}) { return <View style={styles.backgroundRow}><Ionicons name={icon} size={19} color={colors.sage}/><Text style={styles.backgroundText}>{text}</Text></View>; }
