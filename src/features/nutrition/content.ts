...
// This is intentionally a small, conservative seed library. It is educational
// content, not a personalised meal prescription. Future clinical content must
// carry source/reviewer metadata before it is expanded.
export const nutritionTopics: NutritionTopic[] = [
  {
    ...
    trimester: 'all',
    tags: ['everyday', 'vegetarian', 'non-vegetarian'],
    points: [
